...
def is_object_visible(object, variantIDs):
    print("is_object_visible(" + object.name + ", " + str(variantIDs) + ")")
...
def optimize_mesh(vertexdata, maxCoordDelta, maxUVDelta, maxNormalAngle):
    print("optimizing mesh: maxCoordDelta " + str(maxCoordDelta) + ", maxUVDelta: " + str(maxUVDelta) + ", maxNormalAngle: " + str(maxNormalAngle))
